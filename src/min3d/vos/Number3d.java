...
public class Number3d 
{
	...
	//Custom Code
	public float customRotAngle;
	
	//Custom Code
	public float initXDir;
	public float initYDir;
	public float initZDir;
	
	//Custom Code
	public float initRotAngle;
	...
	//Custom Code
	public void setCustomRotationDirection(float $x, float $y, float $z){
		xDir = $x;
		yDir = $y;
		zDir = $z;
	
		enableCustomRotation();
	}
	
	//Custom Code
	private void enableCustomRotation(){
		this.customRotation = true;
	}

	//Custom Code
	public boolean isCustomRotationEnabled(){
